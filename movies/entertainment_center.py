...
inside_man = media.Movie("Inside Man",
                         "The volatile showdown between a determined cop and a perfectionist bank robber is sent spiraling toward disaster when a scheming power broker steps in to take control of the situation",
...
the_big_short = media.Movie("The Big Short",
                            "In 2005, eccentric hedge fund manager Michael Burry discovers that the United States housing market is extremely unstable, being based on high-risk subprime loans.",
                            "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRCb6lxfYBkprudGKI83kGztRtUd2_BTpCurkpIUjSxUI4ruiJB8g",
...
the_martian = media.Movie("The Martian",
                          ...
                          "https://www.youtube.com/results?search_query=the+martian")

pulp_fiction = media.Movie("Pulp Fiction",
                           "Hitmen Jules Winnfield and Vincent Vega are on their way to retrieve a briefcase from Brett, who has transgressed against their boss, gangster Marsellus Wallace.",
...
enter_the_dragon = media.Movie("Enter the Dragon",
                               ...
                               "https://upload.wikimedia.org/wikipedia/en/thumb/e/ef/Enter_the_dragon.jpg/220px-Enter_the_dragon.jpg",
...
monsters_inc = media.Movie("Monsters, INC.",
                           "Hulking, blue-furred behemoth James P. Sullivan (John Goodman) and his one-eyed assistant Mike Wazowski (Billy Crystal) are employed by Monsters, Inc., a scream processing factory.",
